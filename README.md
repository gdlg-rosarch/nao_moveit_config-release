## nao_moveit_config (kinetic) - 0.0.11-0

The packages in the `nao_moveit_config` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release nao_moveit_config -t kinetic -r kinetic --new-track` on `Fri, 20 Jan 2017 16:29:49 -0000`
...
## nao_moveit_config (jade) - 0.0.11-0

The packages in the `nao_moveit_config` repository were released into the `jade` distro by running `/usr/bin/bloom-release nao_moveit_config -t jade -r jade` on `Fri, 20 Jan 2017 16:25:58 -0000`
...
## nao_moveit_config (indigo) - 0.0.11-0

The packages in the `nao_moveit_config` repository were released into the `indigo` distro by running `/usr/bin/bloom-release nao_moveit_config -t indigo -r indigo` on `Fri, 20 Jan 2017 16:23:34 -0000`
...
## nao_moveit_config (jade) - 0.0.10-0

The packages in the `nao_moveit_config` repository were released into the `jade` distro by running `/usr/bin/bloom-release nao_moveit_config --track jade --rosdistro jade --new-track` on `Sun, 18 Sep 2016 16:39:18 -0000`
...
## nao_moveit_config (indigo) - 0.0.9-0
